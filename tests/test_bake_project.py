...
def test_bake_with_defaults(cookies):
    with bake_in_temp_dir(cookies) as result:
        ...
        assert 'news' in found_toplevel_files
        assert 'README.md' in found_toplevel_files
        assert '.isort.cfg' in found_toplevel_files
...
# TODO: add console entry point to pyproject.toml
